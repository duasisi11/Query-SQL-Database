...
--delete from [tbl_buku] where id_buku = 6

-- DBCC CHECKIDENT ("tbl_kategori", RESEED, 0); -- mengatur AUTO_INCREMENT Reset mulai dari 1
-- DBCC CHECKIDENT ("tbl_buku", RESEED, 0);  -- mengatur AUTO_INCREMENT Reset mulai dari 1
-- DBCC CHECKIDENT ("tbl_buku", RESEED, 4);   -- mengatur AUTO_INCREMENT Reset mulai dari 5
...
--delete from tbl_det_peminjaman
--DBCC CHECKIDENT ("tbl_det_peminjaman", RESEED, 0);
